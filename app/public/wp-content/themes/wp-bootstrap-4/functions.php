...
function wp_bootstrap_4_widgets_init() {
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Inline Ad', 'wp-bootstrap-4' ),
		'id'            => 'inline-ad',
		'description'   => esc_html__( 'Add widgets here.', 'wp-bootstrap-4' ),
		'before_widget' => '',
		'after_widget'  => '',
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Below Header', 'wp-bootstrap-4' ),
		'id'            => 'below-header',
		'description'   => esc_html__( 'Add widgets here.', 'wp-bootstrap-4' ),
		'before_widget' => '',
		'after_widget'  => '',
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Above Footer', 'wp-bootstrap-4' ),
		'id'            => 'above-footer',
		'description'   => esc_html__( 'Add widgets here.', 'wp-bootstrap-4' ),
		'before_widget' => '',
		'after_widget'  => '',
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Footer Full Width', 'wp-bootstrap-4' ),
...
function wp_bootstrap_4_scripts() {
	// wp_enqueue_style( 'open-iconic-bootstrap', '/assets/css/open-iconic-bootstrap.css', array(), 'v4.0.0', 'all' );
	// wp_enqueue_style( 'bootstrap-4', '/assets/css/bootstrap.css', array(), 'v4.0.0', 'all' );
	// wp_enqueue_style( 'wp-style', get_stylesheet_uri(), array(), '1.0.2', 'all' );

	// wp_enqueue_script( 'bootstrap-4-js', '/assets/js/bootstrap.js', array('jquery'), 'v4.0.0', true );
